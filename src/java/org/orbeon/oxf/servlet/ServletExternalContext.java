...
public class ServletExternalContext extends ServletWebAppExternalContext implements ExternalContext  {
    ...
    public static final String HTTP_PAGE_NOCACHE_DEFAULT     = "Cache-Control: private, max-age=0; Pragma:";
    public static final String HTTP_PAGE_NOCACHE_PROPERTY    = "oxf.http.page.headers.nocache";
    public static final String HTTP_PAGE_CACHE_DEFAULT       = "Cache-Control: public; Pragma:";
    public static final String HTTP_PAGE_CACHE_PROPERTY      = "oxf.http.page.headers.cache";
    public static final String HTTP_RESOURCE_CACHE_DEFAULT   = HTTP_PAGE_CACHE_DEFAULT;
    public static final String HTTP_RESOURCE_CACHE_PROPERTY  = "oxf.http.resource.headers.cache";
    ...
    private static Map<String, String> responseNocacheHeaders;
    private static Map<String, String> responseCacheHeaders;
    private static Map<String, String> responseResourceCacheHeaders;
    ...
    private static Map<String, String> getPageNocacheHeaders() {
        if (responseNocacheHeaders == null)
            responseNocacheHeaders = decodeCacheString(HTTP_PAGE_NOCACHE_PROPERTY, HTTP_PAGE_NOCACHE_DEFAULT);
        return responseNocacheHeaders;
    }

    private static Map<String, String> getPageCacheHeaders() {
        if (responseCacheHeaders == null)
            responseCacheHeaders = decodeCacheString(HTTP_PAGE_CACHE_PROPERTY, HTTP_PAGE_CACHE_DEFAULT);
        return responseCacheHeaders;
    }

    private static Map<String, String> getResourceCacheHeaders() {
        if (responseResourceCacheHeaders == null)
            responseResourceCacheHeaders = decodeCacheString(HTTP_RESOURCE_CACHE_PROPERTY, HTTP_RESOURCE_CACHE_DEFAULT);
        return responseResourceCacheHeaders;
    }
    ...
    private class Response implements ExternalContext.Response {
        ...
        public void setCaching(long lastModified, boolean revalidate, boolean allowOverride) {
            ...
            if (revalidate) {
                ...
                setResponseHeaders(nativeResponse, getPageNocacheHeaders());
